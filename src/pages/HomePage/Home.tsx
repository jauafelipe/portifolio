    ...
    return (
        ...
        <FlexBoxContainer style={{
            ...
            <div  id="projects">
                <BoxContainer
                    ...
                    link="https://github.com/jauafelipe/api-ASP.NET"
                    icon={[
                        <GrGraphQl size={50} color="#8338ec" />,
                        <AiOutlineDotNet size={50} />]}
                    button={<ButtonComponent text="redirecionar" onclick={() => handleClick("redirecionando graphqlapi")}  />}
                />
            </div>
            <div>
        ...
        <footer className="footer-container" id="contact">
            ...
            <div className="container-ig-pessoal">
                ...
                <h2>meu instagram para uso pessoal como também para contato</h2>
            </div>
            ...
            <div className="discord">
                ...
                <h2>meu discord para contatos também</h2>
            </div>
        </footer>
    </main>
    )
